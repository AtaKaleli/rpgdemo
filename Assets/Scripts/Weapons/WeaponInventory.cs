...
public class WeaponInventory : MonoBehaviour
{
    ...
    {
        if (currentWeaponIdx == slotIdx - 1 || !ActiveWeapon.instace.CanAttack) // if player tries to toggle active weapon slot or is attacking with any weapon, just dont allow toggling
            return;
